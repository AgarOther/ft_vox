...
std::vector<Texture*> TextureType::generateTextures(Material material)
{
	...
	switch (material)
	{
		...
		case CRIMSON_NYLIUM:
		{
			textures.push_back(new Texture("textures/crimson_nylium_top.png", GL_TEXTURE_2D, 0, GL_RGB, GL_UNSIGNED_BYTE));
			textures.push_back(new Texture("textures/crimson_nylium_side.png", GL_TEXTURE_2D, 1, GL_RGB, GL_UNSIGNED_BYTE));
			textures.push_back(new Texture("textures/netherrack.png", GL_TEXTURE_2D, 2, GL_RGB, GL_UNSIGNED_BYTE));
			break;
		}
		case GRASS_BLOCK:
